...
Images of various degree of similarity (Images from Usplash).
:::
...
A *representation* maps raw, high-dimensional input $x$ (pixels, words, amino acids, nodes) into a vector (or set of tokens) $z = f(x)$ capturing task-relevant structure while discarding nuisance variation.
...
| Modality | Example Unit | Typical Raw Dimensionality (Sample) | Challenges |
|----------|--------------|--------------------------------------|------------|
| Images | 224x224 RGB | ~150K pixels | Local correlations, spatial invariance |
...
: Representative raw modality characteristics {.striped .hover #tbl-repr-modalities}
...
### 1.1 Invariance vs Equivariance
...
<!-- TODO: Visual: Grid of activations from early vs mid vs deep CNN layer; plus ViT attention heads highlighting object parts. -->
