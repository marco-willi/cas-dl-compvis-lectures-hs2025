...
- Articulate ethical considerations (misinformation, bias, synthetic media) at a high level.
...
[Example from Waymo](https://waymo.com/waymo-driver/). Observe how the system simultaneously tracks multiple objects and predicts their trajectories.
...
Computer vision has also proven valuable in agriculture. @fig-intro-minneapple shows an application where apples are automatically counted from images. Drones equipped with CV models can estimate crop yield, identify plant species, detect diseases, and assess overall crop health—enabling precision agriculture.
...
The same cat from different viewpoints looks completely different at the pixel level. [Source](http://cs231n.stanford.edu/)
:::
