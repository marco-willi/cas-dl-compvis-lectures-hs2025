...
Face recognition technology, such as Apple's Face ID (@fig-intro-face-id), has become ubiquitous. In this case depth information is derived from infrared light.
...
Computer vision has also been very useful in agriculture. @fig-intro-minneapple shows an application where apples can be counted from image data. Furthermore, drones might be used to estimate crop yield, type, and health.
