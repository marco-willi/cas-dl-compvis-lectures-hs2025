...
Images have the following relevant properties when modeling them:
...
- Stability under transformations: Interpretation of an image does not change under many geometric transformations.
...
::: {.callout-note title="Quiz: Output Shape" collapse="true"}
Given: $i=32, k=3, p=1, s=2, d=1$. What is $o$?

Solution: $o = \lfloor (32 + 2 - 1\cdot(3-1) -1)/2 + 1 \rfloor = \lfloor (32)/2 + 1 \rfloor = 17$.
:::
