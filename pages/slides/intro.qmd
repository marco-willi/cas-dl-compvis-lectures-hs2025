...
Many image-level tasks extend naturally to videos - after all, videos are sequences of images.

**Video-Specific Challenges:**

- Temporal consistency across frames
- Motion patterns and dynamics
...
Even though the circled blobs are identical, we interpret them as different objects based on context. Source @torralba_using_2010
:::
