...
We now take a look at a few examples:

Biologists might need to analyze images from camera traps for species identification (see @fig-intro-kora-lynx). Compuer vision can help automate that to a large degree (@Images2018).
...
![Example from @hani_minneapple_2020]({{< meta params.images_path >}}minneapple.png){width=600}
...
![Example from @ma_segment_2024.]({{< meta params.images_path >}}medsam.png){width=600}
